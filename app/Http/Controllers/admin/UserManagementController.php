...
class UserManagementController extends Controller
{
    ...
    public function newOfficeEmployee(){
        ...
        $data['users']=User::where('user_type','office_employee')->where('status','!=','approved')->get();
        return view('admin.pages.user_management.newOfficeEmployee',$data);
    }

    public function newFieldDriver(){
        $data['title']='New Field Emplyee';
        $data['users']=User::with('employee')->where('user_type','field_employee')->where('status','!=','approved')->get();
        return view('admin.pages.user_management.newFieldDriver',$data);
    }

    public function newSalesEmployee(){
        $data['title']='new Sales Employee';
        $data['users']=User::with('employee')->where('user_type','sales_employee')->where('status','!=','approved')->get();
    ...
    public function approvedOfficeEmployee(){
        ...
        $data['users']=User::with('employee')->where('user_type','office_employee')->where('status','=','approved')->get();
    ...
    public function approvedFieldDriver(){
        ...
        $data['users']=User::where('user_type','field_employee')->where('status','=','approved')->get();
    ...
    public function approvedSalesEmployee(){
        ...
        $data['users']=User::where('user_type','sales_employee')->where('status','=','approved')->get();
